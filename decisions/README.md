...
| [`ADR-0003-core-v0.2-project-core.md`](ADR-0003-core-v0.2-project-core.md) | CORE v0.2 "Project Core" vertical slice (manifest, CLI, validator, tests) | Proposed (pending PR #4 merge) |
